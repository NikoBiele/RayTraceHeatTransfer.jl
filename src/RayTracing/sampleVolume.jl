...
This function samples an emission point and direction in a volume (a surface in 2D),
by separating it in two triangles and sampling according to their area.
This operation requires knowledge of the mesh, which is why the mesh is also an input.
"""
function sampleVolume(mesh::RayTracingMesh, xCount::Int64, yCount::Int64)
