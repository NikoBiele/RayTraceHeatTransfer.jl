    ...
    for iter = 1:max_iter
        ...
        for i = 1:rtm.n_spectral_bins
            ...
            if i == rtm.n_spectral_bins
                ...
                F_upper = emitFracBlackBodySpectrum(rtm.wavelength_band_limits, T, i)   # Upper boundary
            end
            ...
            if i == 1
                ...
                dF_lower_dT = emitFracBlackBodySpectrumDerivative(rtm.wavelength_band_limits, T, i-1)
            end
            if i == rtm.n_spectral_bins
                dF_upper_dT = 0.0
            else
                dF_upper_dT = emitFracBlackBodySpectrumDerivative(rtm.wavelength_band_limits, T, i)
            end
